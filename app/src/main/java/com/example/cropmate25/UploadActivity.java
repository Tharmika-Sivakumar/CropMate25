...
public class UploadActivity extends AppCompatActivity {
    ...
    Button saveButton;
    EditText uploadTitle, uploadDesc, uploadLoc, uploadPrice;
    String imageURL;
    Uri uri;
    ...
    public void saveData() {
        StorageReference storageReference = FirebaseStorage.getInstance().getReference().child("Android Tutorials")
    ...
    public void uploadData() {
        ...
        String loc = uploadLoc.getText().toString();

        if (title.isEmpty() || desc.isEmpty() || price.isEmpty() || loc.isEmpty() || imageURL == null) {
            Toast.makeText(this, "Please fill all fields and upload an image", Toast.LENGTH_SHORT).show();
            return;
        }

        DataClass dataClass = new DataClass(title, desc, price, loc, imageURL);
