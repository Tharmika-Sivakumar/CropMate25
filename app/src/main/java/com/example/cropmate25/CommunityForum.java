...
public class CommunityForum extends AppCompatActivity {
    ...
    List<DataClassForum> dataList;
    MyAdapterForum adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("Forum Images");
        eventListener = databaseReference.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                dataList.clear();
                for (DataSnapshot itemSnapshot : snapshot.getChildren()) {
                    DataClassForum dataClass = itemSnapshot.getValue(DataClassForum.class);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(CommunityForum.this, uploadActivityForum.class);
